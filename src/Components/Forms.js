        ...
        <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
          ...
          <div className="col-span-full">
            ...
            <div className="mt-2 flex items-center gap-x-3">
              ...
              <button
                type="button"
                className="rounded-md bg-white px-2.5 py-1.5 text-sm font-semibold text-white-900 shadow-sm ring-1 ring-inset ring-white-300 hover:bg-white-50"
              >
                Change
              </button>
            </div>
          ...
          <div className="sm:col-span-3">
            ...
            <div className="mt-2">
              <select
                ...
                className="block w-full rounded-md border-0 py-1.5 text-white-900 shadow-sm ring-1 ring-inset ring-white-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:max-w-xs sm:text-sm sm:leading-6"
              >
            ...
            <div className="mt-6 space-y-6">
              <div className="flex items-center gap-x-3">
                <input
                  ...
                  type="radio"
                  className="h-4 w-4 border-white-300 text-indigo-600 focus:ring-indigo-600"
                />
